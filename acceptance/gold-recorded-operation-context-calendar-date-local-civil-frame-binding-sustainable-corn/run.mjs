...
console.log(JSON.stringify({
  ok: true,
  authority: 'AgronomicContextCalendarDateLocalCivilFrameBindingCompilation',
  goldKind: 'PUBLIC_REAL_SOURCE_CUMULATIVE',
  parentSourceNativeTimezoneIdentityBinding: timezonePublished.ref,
  targetContextSemantic: localCivilFrameValidated.semanticPayload.binding.targetContextSemantic,
  sourceTemporalDescriptor: localCivilFrameValidated.semanticPayload.binding.sourceTemporalDescriptor,
  sourceNativeSubject: localCivilFrameValidated.semanticPayload.binding.sourceNativeSubject,
  sourceTimezone: localCivilFrameValidated.semanticPayload.binding.sourceTimezone,
  temporalFrame: localCivilFrameValidated.semanticPayload.binding.temporalFrame,
  interpretationClass: localCivilFrameValidated.semanticPayload.binding.interpretationClass,
  upstreamSourceDeclaredFrameClaimCreated: false,
  ...
  negativeCases: [
    ...
    'SOURCE_DATE_PRECISION_DRIFT_DENIED',
    'SOURCE_SUBJECT_DRIFT_DENIED',
    'TIMEZONE_DRIFT_DENIED',
    'UPSTREAM_SOURCE_DECLARATION_SUBSTITUTION_DENIED',
    'OFFSET_DST_TZDB_EFFECTIVE_INTERVAL_WIDENING_DENIED',
    'GENERIC_PROVIDER_GEOGRAPHIC_RULE_WIDENING_DENIED',
