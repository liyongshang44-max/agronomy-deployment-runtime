...
console.log(JSON.stringify({
  ok: true,
  authority: 'AgronomicContextHistoricalTimezoneBoundaryResolutionCompilation',
  goldKind: 'PUBLIC_REAL_SOURCE_CUMULATIVE',
  parentCalendarDateLocalCivilFrameBinding: localCivilFramePublished.ref,
  targetContextSemantic:
    historicalTimezoneValidated.semanticPayload.resolution.targetContextSemantic,
  localCivilFrame:
    historicalTimezoneValidated.semanticPayload.resolution.localCivilFrame,
  timezoneRuleAuthority:
    historicalTimezoneValidated.semanticPayload.resolution.timezoneRuleAuthority,
  historicalResolution:
    historicalTimezoneValidated.semanticPayload.resolution.historicalResolution,
  localBoundaryProjection:
    historicalTimezoneValidated.semanticPayload.resolution.localBoundaryProjection,
  effectiveInterval:
    historicalTimezoneValidated.semanticPayload.resolution.effectiveInterval,
  hostTimezoneAuthorityUsed: false,
  mutableLatestAuthorityUsed: false,
  genericTimezoneEngineAuthorityCreated: false,
  dateValueMutatedToTimestamp: false,
  availableAtAuthorityMutated: false,
  contextDatumAuthorityCreated: false,
  negativeCases: [
    'WRONG_PARENT_KIND_DENIED',
    'PREDECESSOR_REF_DRIFT_DENIED',
    'MUTABLE_LATEST_RULE_ALIAS_DENIED',
    'WRONG_TZDB_RELEASE_DENIED',
    'WRONG_TZDATA_SHA512_DENIED',
    'MISSING_RETAINED_RULE_EVIDENCE_DENIED',
    'ALTERED_NORTHAMERICA_RULE_BYTES_DENIED',
    'WRONG_TRANSITION_DERIVATION_DENIED',
    'STANDARD_TIME_SUBSTITUTION_DENIED',
    'ARBITRARY_EFFECTIVE_INTERVAL_DENIED',
    'HOST_TIMEZONE_FALLBACK_FIELD_DENIED',
    'AVAILABLE_AT_MUTATION_DENIED',
    'INTERVAL_CLOSURE_POLICY_DENIED',
    'DATE_TO_TIMESTAMP_MUTATION_DENIED',
