...
console.log(JSON.stringify({
  ...
  sourceProviderIdentityBinding: providerIdentityPublished.ref,
  providerId:
    sourceProjectionValidated.semanticPayload.projection.providerId,
  sourceLocator:
    sourceProjectionValidated.semanticPayload.projection.sourceLocator,
  projectedSource:
    sourceProjectionValidated.semanticPayload.projection.projectedSource,
  artifactHashRetainedForClosure:
    sourceProjectionValidated.semanticPayload.projection.valueSource
      .sourceArtifactContentHash,
  publicContentHashUsesEvidenceHash: true,
  temporalSupport: temporalSupportValidated.semanticPayload.classification.temporalSupport,
  sourceNativeTimezone: timezoneValidated.semanticPayload.binding.sourceTimezone,
  spatialSupport: spatialValidated.semanticPayload.classification.spatialSupport,
  spatialSupportTargetIdentityLineage:
    spatialValidated.semanticPayload.classification.sourceBackedTargetIdentity,
  spatialSupportTargetInstanceIdentityCreated: false,
  spatialSupportGeometryRefCreated: false,
  spatialSupportUniformWithinFarmAuthorityCreated: false,
  coPredecessorParentOccurrenceRef: spatialValidated.parentOccurrence.record.ref,
  effectiveIntervalAuthorityCreated: false,
  timezoneIdentityAuthorityCreated: true,
  calendarDateLocalFrameAuthorityCreated: false,
  utcOffsetAuthorityCreated: false,
  dstAuthorityCreated: false,
  tzdbVersionAuthorityCreated: false,
  availableAtAuthorityCreated: false,
  contextDatumAuthorityCreated: false,
  negativeCases: [
    'SOURCE_REF_ROW_DRIFT_DENIED',
    'SOURCE_REF_BLOB_DRIFT_DENIED',
    'SOURCE_REF_PATH_DRIFT_DENIED',
    'ARTIFACT_HASH_AS_PUBLIC_CONTENT_HASH_DENIED',
    'OCCURRENCE_HASH_AS_PUBLIC_CONTENT_HASH_DENIED',
    'ARBITRARY_HASH_DENIED',
    'SOURCE_LOCATOR_DRIFT_DENIED',
    'PROVIDER_ID_DRIFT_DENIED',
    'TARGET_MAPPING_DRIFT_DENIED',
    'INCOMPLETE_REVIEW_DENIED',
    'UNAUTHORIZED_REVIEWER_DENIED',
    'REJECTED_REVIEW_DENIED',
    'SOURCE_TEMPORAL_DRIFT_DENIED',
    'NON_INTERVAL_SUPPORT_DENIED',
    'TIMEZONE_EFFECTIVE_INTERVAL_AVAILABLE_AT_WIDENING_DENIED',
    'TEMPORAL_SUPPORT_INCOMPLETE_REVIEW_DENIED',
    'TEMPORAL_SUPPORT_UNAUTHORIZED_REVIEWER_DENIED',
    'TEMPORAL_SUPPORT_REJECTED_REVIEW_DENIED',
    'TIMEZONE_ALIAS_AND_OFFSET_IDENTITY_DENIED',
    'TIMEZONE_SUBJECT_DRIFT_DENIED',
    'TIMEZONE_EVIDENCE_RANGE_DRIFT_DENIED',
    'TIMEZONE_EVIDENCE_HASH_DRIFT_DENIED',
    'CO_PREDECESSOR_PARENT_REF_DRIFT_DENIED',
    'OFFSET_DST_TZDB_LOCAL_FRAME_EFFECTIVE_TIME_WIDENING_DENIED',
    'TIMEZONE_INCOMPLETE_REVIEW_DENIED',
    'TIMEZONE_UNAUTHORIZED_REVIEWER_DENIED',
    'TIMEZONE_REJECTED_REVIEW_DENIED',
    'NON_FARM_SPATIAL_SUPPORT_DENIED',
    'GEOMETRY_REF_INJECTION_DENIED',
    'FABRICATED_TARGET_ID_DENIED',
    'SPATIAL_CONTEXT_VALUE_DRIFT_DENIED',
    'SPATIAL_INCOMPLETE_REVIEW_DENIED',
    'SPATIAL_UNAUTHORIZED_REVIEWER_DENIED',
    'SPATIAL_REJECTED_REVIEW_DENIED',
    'SPATIAL_CO_PREDECESSOR_PARENT_REF_DRIFT_DENIED'
  ],
