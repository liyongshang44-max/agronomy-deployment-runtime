...
console.log(JSON.stringify({
  ...
  contextProvenanceClassification: provenancePublished.ref,
  valueSource:
    providerIdentityValidated.semanticPayload.binding.valueSource,
  exactOriginLocator:
    providerIdentityValidated.semanticPayload.binding.sourceNamespaceEvidence
  ...
  provenanceClass:
    providerIdentityValidated.semanticPayload.binding.provenanceClass,
  sourceRefWireAuthorityCreated: false,
  contentHashWireAuthorityCreated: false,
  negativeCases: [
    'HOST_ONLY_PROVIDER_ID_DENIED',
    'INSTITUTIONAL_PROVIDER_IDS_DENIED',
    'ADR_OWNER_PROVIDER_ID_DENIED',
    'SOURCE_LOGICAL_ID_PROVIDER_ID_DENIED',
    'OTHER_REPOSITORY_PROVIDER_ID_DENIED',
    'ORIGIN_LOCATOR_DRIFT_DENIED',
