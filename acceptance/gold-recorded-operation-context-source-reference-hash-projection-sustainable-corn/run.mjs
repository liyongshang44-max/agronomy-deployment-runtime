...
for (const badSourceRef of [
  ...
  expectSourceProjectionError(
    ...
    'UNSUPPORTED_AGRONOMIC_RECORDED_OPERATION_CONTEXT_SOURCE_REFERENCE_HASH_SOURCE_REF'
  );
}
...
for (const badHash of [
  ...
  expectSourceProjectionError(
    ...
    'AGRONOMIC_RECORDED_OPERATION_CONTEXT_SOURCE_REFERENCE_HASH_CONTENT_HASH_MISMATCH'
  );
}
...
expectSourceProjectionError(
  ...
  'UNSUPPORTED_AGRONOMIC_RECORDED_OPERATION_CONTEXT_SOURCE_REFERENCE_HASH_LOCATOR'
);
...
expectSourceProjectionError(
  ...
  'AGRONOMIC_RECORDED_OPERATION_CONTEXT_SOURCE_REFERENCE_HASH_TARGET_MISMATCH'
);
