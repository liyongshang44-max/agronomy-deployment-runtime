...
console.log(JSON.stringify({
  ok: true,
  authority: 'AgronomicContextTargetRefFarmInstanceProjectionCompilation',
  goldKind: 'PUBLIC_REAL_SOURCE_CUMULATIVE',
  parentSpatialSupportClassification: spatialPublished.ref,
  targetContextSemantic:
    targetRefValidated.semanticPayload.projection.targetContextSemantic,
  sourceBackedTargetIdentity:
    targetRefValidated.semanticPayload.projection.sourceBackedTargetIdentity,
  targetRefProjection:
    targetRefValidated.semanticPayload.projection.targetRefProjection,
  rawSerfUsedAsFarmId: false,
  displayNameUsedAsFarmId: false,
  completeTargetRefAuthorityCreated: false,
  organizationTenantAuthorityCreated: false,
  fieldSeasonZoneAuthorityCreated: false,
  geometryAuthorityCreated: false,
  decisionProblemAuthorityCreated: false,
  contextManifestAuthorityCreated: false,
  contextDatumAuthorityCreated: false,
  crossProviderCanonicalIdentityCreated: false,
  inverseWriteBackAuthorityCreated: false,
  temporalAuthorityCreated: false,
  availableAtAuthorityCreated: false,
  negativeCases: [
    'WRONG_PARENT_KIND_DENIED',
    'PREDECESSOR_REF_DRIFT_DENIED',
    'TARGET_SEMANTIC_VALUE_DRIFT_DENIED',
    'NON_FARM_GRANULARITY_DENIED',
    'TARGET_ID_DRIFT_DENIED',
    'RAW_SERF_AS_FARM_ID_DENIED',
    'DISPLAY_NAME_AS_FARM_ID_DENIED',
    'ARBITRARY_FARM_ID_DENIED',
    'WRONG_TARGET_REF_FIELD_DENIED',
    'ORGANIZATION_TENANT_FIELD_SEASON_ZONE_WIDENING_DENIED',
    'GEOMETRY_WIDENING_DENIED',
    'CROSS_PROVIDER_EQUIVALENCE_DENIED',
