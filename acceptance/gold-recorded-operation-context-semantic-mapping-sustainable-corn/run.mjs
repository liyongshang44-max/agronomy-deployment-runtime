...
console.log(JSON.stringify({
  ok: true,
  authority: 'AgronomicRecordedOperationContextSemanticMappingCompilation',
  goldKind: 'PUBLIC_REAL_SOURCE',
  parentOccurrenceCompilation: parent.published.ref,
  semanticNormalizationCompilation: normalizationPublished.ref,
  parentOccurrence: {
    sourceOperationCode:
      mappingValidated.parentOccurrence.semanticPayload.occurrence
    ...
    temporalSupport:
      mappingValidated.parentOccurrence.semanticPayload.occurrence
        .occurrenceSemantics.temporalSupport
  },
  normalizedOperation:
    mappingValidated.semanticNormalization.semanticPayload.normalization
      .normalizedOperation,
  targetContextSemantic:
    mappingValidated.semanticPayload.mapping.targetContextSemantic,
  negativeCases: [
    'SOURCE_DATE_DRIFT_DENIED',
    'TARGET_DATE_DRIFT_DENIED',
    'FAMILY_DRIFT_DENIED',
    'SUBJECT_KIND_DRIFT_DENIED',
    'SUBJECT_CODE_DRIFT_DENIED',
    'ARBITRARY_SEMANTIC_ID_DENIED',
    'TIMESTAMP_TARGET_DENIED',
    'PARENT_CLOSURE_DRIFT_DENIED',
