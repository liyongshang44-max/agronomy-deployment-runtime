...
- `AgronomicPolicyCompilation` records how exact protocol artifacts, knowledge, model, and policy authorities were operationalized and who approved that operationalization.
