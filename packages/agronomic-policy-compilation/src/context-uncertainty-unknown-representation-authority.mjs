...
export const AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_DISPOSITIONS =
  deepFreeze([
    'ACCEPT_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION',
    'REJECT_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION'
  ]);

export const AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REQUIRED_REVIEW_CHECKS =
  deepFreeze([
    'PARENT_CONTEXT_SEMANTIC_MAPPING_AUTHORITY_VERIFIED',
    'EXACT_TARGET_CONTEXT_SEMANTIC_VERIFIED',
    'EXACT_TARGET_VALUE_VERIFIED',
    'ACCEPTED_EVIDENCE_SCOPE_REVALIDATED',
    'UNKNOWN_UNCERTAINTY_REPRESENTATION_VERIFIED',
    'EXACT_UNCERTAINTY_REASON_CODE_VERIFIED',
    'NO_UNCERTAINTY_NONE_INFERENCE',
    'NO_NUMERIC_UNCERTAINTY_INTERVAL_INFERENCE',
    'NO_CATEGORICAL_ALTERNATIVES_INFERENCE',
    'NO_DISTRIBUTION_REFERENCE_INFERENCE',
    'NO_VALUE_UNKNOWN_SUBSTITUTION',
    'NO_SOURCE_GLOBAL_NOT_REPORTED_CLAIM',
    'NO_GENERIC_DATE_TYPE_INFERENCE',
    'NO_GENERIC_EPISTEMIC_CLASS_INFERENCE',
...
const REVIEW_DISPOSITIONS =
  new Set(AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_DISPOSITIONS);
const REQUIRED_CHECKS =
  new Set(AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REQUIRED_REVIEW_CHECKS);
...
function requireLedger(ledger) {
  if (!ledger
    ...
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_LEDGER_REQUIRED',
      'uncertainty unknown representation authority requires AuthorityLedger'
    );
  }
}
...
function normalizeReviewerPrincipal(value) {
  if (!value || typeof value !== 'object' || Array.isArray(value)) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEWER_REQUIRED',
...
function normalizeReviewChecks(values, disposition) {
  if (!Array.isArray(values)) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_CHECKS_REQUIRED',
  ...
  if (new Set(normalized).size !== normalized.length) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_CHECKS_INVALID',
  ...
  for (const value of normalized) {
    if (!REQUIRED_CHECKS.has(value)) {
      throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
        'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_CHECKS_INVALID',
        `unsupported uncertainty unknown representation review check ${value}`
      );
    }
  }
  if (disposition === 'ACCEPT_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION') {
    for (const required of REQUIRED_CHECKS) {
      if (!normalized.includes(required)) {
        throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
          'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_INCOMPLETE',
          `accepted uncertainty unknown representation review must confirm ${required}`
        );
      }
    }
  }
...
function normalizeAuthorizationRefs(values) {
  if (!Array.isArray(values) || values.length === 0) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_AUTHORIZATION_REQUIRED',
...
function resolveAuthorizationCoverage({
  ...
  if (selectedKeys.size !== refs.length) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_AUTHORIZATION_SCOPE_EXCESS',
...
function assertAuditActor(audit, principal) {
  if (!audit?.actor
    ...
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_ACTOR_MISMATCH',
      'audit actor must match the exact uncertainty unknown representation reviewer'
    );
  }
}
...
function validateRepresentationWorld({ ledger, sourceRegistry, representation }) {
  ...
  if (!sameSemanticValue(targetContextSemantic, normalized.targetContextSemantic)) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_TARGET_MISMATCH',
  ...
  if (targetContextSemantic.semanticId !== 'crop.planting_date'
    ...
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_PREDECESSOR_DRIFT',
      'DEC-0026 v1 requires exact DEC-0016 crop.planting_date = DATE 2011-05-03'
    );
  }
...
export function publishAgronomicContextUncertaintyUnknownRepresentationReviewDecision({
  ledger,
  sourceRegistry,
  logicalId,
  version,
  ...
  if (!REVIEW_DISPOSITIONS.has(disposition)) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'INVALID_AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_DISPOSITION',
      'unsupported uncertainty unknown representation review disposition'
    );
  }
  ...
  const representationHash =
    agronomicContextUncertaintyUnknownRepresentationHash(world.normalized);
  ...
  return ledger.publish({
    ...
    semanticPayload: {
      authorityClass:
        'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_AUTHORITY',
    ...
    audit: {
      ...audit,
      action: 'REVIEW_AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION',
      inputRefs: [
        world.normalized.parentContextSemanticMappingCompilationRef,
        world.mapping.semanticPayload.mapping.parentOccurrenceCompilationRef,
        ...world.requiredSources.map((source) => source.ref),
      ...
      details: {
        ...
        uncertaintyRepresentation:
          cloneCanonicalValue(world.normalized.uncertaintyRepresentation)
      }
    }
  });
}
...
function validateReview({
  ...
  if (review.ref.kind
      !== 'AgronomicContextUncertaintyUnknownRepresentationReviewDecision') {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_REQUIRED',
      'publication requires AgronomicContextUncertaintyUnknownRepresentationReviewDecision'
    );
  }
  ...
  if (payload.authorityClass
      !== 'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_AUTHORITY') {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_INVALID',
      'uncertainty unknown representation review has invalid authorityClass'
    );
  }
  if (payload.disposition
    ...
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      ...
      'only accepted uncertainty unknown representation review can authorize publication'
    );
  }
  ...
  if (payload.representationHash !== representationHash
    ...
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      ...
      'review must bind the exact normalized uncertainty unknown representation'
    );
  }
  ...
  if (!sameSemanticValue(payload.predecessorBindings, expectedBindings)) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_PREDECESSOR_MISMATCH',
  ...
  const directAudit = ledger.auditFor(review.ref)
    ...
    .some((event) =>
      event.action
        === 'REVIEW_AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION'
        ...
        && sameSemanticValue(
          event.details?.uncertaintyRepresentation,
  ...
  if (!directAudit) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_REVIEW_AUDIT_INVALID',
      'review lacks direct reviewer audit over the exact uncertainty unknown representation'
    );
  }
...
export function publishAgronomicContextUncertaintyUnknownRepresentationCompilation({
  ledger,
  sourceRegistry,
  logicalId,
  version,
  ...
  if (normalized.losslessCoverage.status !== 'COMPLETE') {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_INCOMPLETE_NOT_PUBLISHABLE',
      'v1 uncertainty unknown representation requires COMPLETE targeted coverage'
    );
  }
  ...
  const review = validateReview({
    ledger,
    sourceRegistry,
    reviewRef: normalized.uncertaintyRepresentationReviewRef,
  ...
  return ledger.publish({
    kind: 'AgronomicContextUncertaintyUnknownRepresentationCompilation',
    logicalId: text(logicalId, 'logicalId'),
    version: text(version, 'version'),
    ...
    audit: {
      ...audit,
      action:
        'PUBLISH_AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_COMPILATION',
      ...
      details: {
        ...
        uncertaintyRepresentationReviewRef: review.review.ref,
        parentContextSemanticMappingCompilationRef:
        ...
        uncertaintyRepresentation:
          cloneCanonicalValue(normalized.representation.uncertaintyRepresentation)
      }
    }
  });
}

export function validateAgronomicContextUncertaintyUnknownRepresentationCompilationAuthority({
  ledger,
  sourceRegistry,
  compilationRef
}) {
  ...
  if (record.ref.kind
    ...
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_COMPILATION_REQUIRED',
      `expected AgronomicContextUncertaintyUnknownRepresentationCompilation, received ${record.ref.kind}`
    );
  }
  ...
  if (normalized.losslessCoverage.status !== 'COMPLETE') {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_INCOMPLETE_AUTHORITY_INVALID',
      'stored v1 uncertainty unknown representation must have COMPLETE targeted coverage'
    );
  }
  ...
  const directAudit = ledger.auditFor(record.ref)
    ...
    .some((event) =>
      event.action
        ...
        && event.details?.uncertaintyRepresentationReviewRef
        && sameAuthorityRef(
          event.details.uncertaintyRepresentationReviewRef,
          review.review.ref
        )
        ...
        && sameSemanticValue(
          event.details?.uncertaintyRepresentation,
          normalized.representation.uncertaintyRepresentation
        )
    );

  if (!directAudit) {
    throw new AgronomicContextUncertaintyUnknownRepresentationCompilationError(
      'AGRONOMIC_CONTEXT_UNCERTAINTY_UNKNOWN_REPRESENTATION_AUDIT_INVALID',
      'uncertainty unknown representation compilation lacks direct reviewer audit'
    );
  }
  ...
  return deepFreeze({
    ...
    uncertaintyRepresentationReview: review.review,
